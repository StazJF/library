    ...
    <div class="col-lg-10">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="bookEditForm" action="<?php echo e(route('books.update', $book)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <table class="table table-sm table-hover mb-0" id="copiesTable">
                                            ...
                                            <tbody id="copiesContainer">
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    <tr>
                                                        <td colspan="<?php echo e($canManageCopies ? 6 : 5); ?>" class="text-center text-muted py-3">No copies yet. Add copies using the button above.</td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <input type="hidden" name="copies" value="<?php echo e(count($copies)); ?>">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const IS_ADMIN = <?php echo json_encode($isAdmin, 15, 512) ?>;
        const CAN_MANAGE_COPIES = <?php echo json_encode($canManageCopies, 15, 512) ?>;
