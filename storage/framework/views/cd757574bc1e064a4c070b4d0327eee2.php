...
<div class="sidebar d-flex flex-column">
 ...
 <!-- Reports -->
        ...
        <a class="nav-link<?php echo e(request()->routeIs('audit.*') ? ' active' : ''); ?>"
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center gap-2"
                               ...
                               aria-expanded="false">
                                <span class="topbar-avatar" aria-hidden="true"><?php echo e($initials); ?></span>
                                <span class="d-none d-md-inline text-truncate" style="max-width: 200px;"><?php echo e($displayName); ?></span>
                                <span class="badge <?php echo e($badgeClass); ?>"><?php echo e($roleLabel); ?></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                <li><h6 class="dropdown-header"><?php echo e($displayName); ?></h6></li>
                                <li><span class="dropdown-item-text text-muted small">Role: <span class="badge <?php echo e($badgeClass); ?>"><?php echo e($roleLabel); ?></span></span></li>
