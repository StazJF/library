                    ...
                    <div class="col-md-12">
                        <form id="filterForm" class="d-flex flex-wrap gap-2 align-items-end">
                            <div class="grow" style="min-width: 200px;">
                                <input type="text" id="remarksSearch" name="remarks" class="form-control form-control-sm" placeholder="Search status remarks..." value="<?php echo e($remarksSearch ?? ''); ?>">
                            </div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small><?php echo e($transaction->getControlNumberRaw()); ?></small>
                                    </td>
                                    <td>
                                    ...
                                    <td class="processed-by-col">
                                        <small><?php echo e($transaction->processed_by_display ?? '—'); ?></small>
                                    </td>
                                    <td>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 gap-2">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination pagination-sm mb-0">
                            ...
                            <?php $__currentLoopData = $transactions->appends(request()->query())->getUrlRange(1, $transactions->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
