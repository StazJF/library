...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php endif; ?>
            <?php if(config('backup.secure_export_dir')): ?>
                <div class="alert alert-secondary mb-3">
                    <i class="fas fa-shield-alt"></i>
                    <strong>Secure copy:</strong> The server also overwrites a copy at
                    <code><?php echo e(config('backup.secure_export_dir')); ?></code>.
                    ...
                    <table class="table table-bordered table-hover align-middle">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $backups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr data-backup-name="<?php echo e($backup['name']); ?>" data-download-url="<?php echo e(route('utilities.downloadBackup', $backup['name'])); ?>">
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('utilities.downloadBackup', $backup['name'])); ?>" class="btn btn-sm btn-primary" title="Download backup" data-download-link>
...
<script>
    ...
    (function () {
        ...
        const downloadBaseUrl = "<?php echo e(url('utilities/download-backup')); ?>/";
