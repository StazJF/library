        ...
        <?php $__empty_1 = true; $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr class="borrow-row" data-origin="<?php echo e($borrow->origin ?? 'personal'); ?>">
                ...
                <td class="d-none d-lg-table-cell processed-by-col">
                    ...
                    ?>
                    <small><?php echo e($processedBy); ?></small>
                </td>
                ...
                <td class="text-center">
                    <form action="<?php echo e(route('borrow.return.process', $borrow->id)); ?>" method="POST" class="d-flex gap-1 justify-content-center align-items-center flex-wrap return-form" data-quantity="<?php echo e($quantity); ?>" data-borrow-id="<?php echo e($borrow->id); ?>">
                        <?php echo csrf_field(); ?>
            ...
            <tr class="borrow-row-teacher" data-origin="<?php echo e($borrow->origin ?? 'personal'); ?>">
                ...
                <td class="d-none d-lg-table-cell">
                    <?php if(($borrow->origin ?? '') === 'distribution' && ($borrow->advisory_grade || $borrow->advisory_section)): ?>
                        <small>Grade <?php echo e($borrow->advisory_grade ?? '-'); ?> <?php echo e($borrow->advisory_section ?? ''); ?></small>
                    <?php else: ?>
